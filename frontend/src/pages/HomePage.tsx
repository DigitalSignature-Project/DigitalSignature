    ...
    <div className="h-full flex flex-col items-center justify-center space-y-10 animate-in fade-in">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 w-full max-w-4xl">
        <button
          ...
          className="group cursor-pointer flex flex-col items-center justify-center p-12 bg-white rounded-2xl shadow-sm border border-slate-100 hover:border-cyan-500 hover:shadow-md transition-all duration-200 hover:-translate-y-1"
        >
          ...
          <p className="text-slate-500 text-center text-sm">
            Secure and sign your files digitally using digital keys.
          </p>
        </button>
