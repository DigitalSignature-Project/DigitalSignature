          ...
          <div className="flex items-center space-x-4">
            ...
            <div className="flex-1">
              <div className="flex justify-between text-sm mb-1">
                <span className="font-medium text-slate-700">Trade_Agreement.pdf (3.4 MB)</span>
        ...
        <div className="mt-12 w-full max-w-md flex items-end justify-between border-t border-slate-100 pt-8">
          <div className="space-y-3">
            <label className="flex items-center space-x-3 cursor-pointer">
              <input type="checkbox" defaultChecked className="w-5 h-5 rounded border-slate-300 text-[#0f172a] focus:ring-[#0f172a]" />
              <span className="text-slate-700 font-medium">AES-256 encryption</span>
            </label>
            <label className="flex items-center space-x-3 cursor-pointer">
              <input type="checkbox" defaultChecked className="w-5 h-5 rounded border-slate-300 text-[#0f172a] focus:ring-[#0f172a]" />
              <span className="text-slate-700 font-medium">Digital Signature (Your Identity)</span>
            </label>
          </div>
          
          <button className="bg-[#1e40af] hover:bg-[#1e3a8a] text-white px-8 py-3 rounded-xl font-semibold shadow-md transition-colors">
            Encrypt and Sign
          </button>
        </div>
