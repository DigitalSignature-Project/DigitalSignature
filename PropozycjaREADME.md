...
6. Run python script to install all dependencies and create virtual environment: python manage.py setup

7. Compile and run application using F5 key or build project using command: python manage.py build & run application using command: python manage.py run
